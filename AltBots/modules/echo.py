    ...
    if event.sender_id in SUDO_USERS:
        if event.reply_to_msg_id:
            ...
            if user_id in ALTRON:
                await event.reply("𝙉𝙤, 𝙏𝙝𝙞𝙨 𝙂𝙪𝙮 𝙄𝙨 𝘿𝙚𝙫𝙚𝙡𝙤𝙥𝙚𝙧 𝙊𝙛 𝙏𝙝𝙚𝙨𝙚 𝘽𝙤𝙩𝙨🫧.")
            elif user_id == OWNER_ID:
                await event.reply("𝙉𝙤, 𝙏𝙝𝙞𝙨 𝙂𝙪𝙮 𝙄𝙨 𝙊𝙬𝙣𝙚𝙧 𝙊𝙛 𝙏𝙝𝙚𝙨𝙚 𝘽𝙤𝙩𝙨 🫧.")
            elif user_id in SUDO_USERS:
                await event.reply("𝙉𝙤, 𝙏𝙝𝙞𝙨 𝙂𝙪𝙮 𝙄𝙨 𝘼 𝙎𝙪𝙙𝙤 𝙐𝙨𝙚𝙧 🇮🇳.")
            else:
                try:
