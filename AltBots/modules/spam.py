...
async def pspam(event):
    if event.sender_id in SUDO_USERS:
        if event.chat_id in GROUP:
            await event.reply("» ꜱᴏʀʀʏ, ᴛʜɪꜱ ɪꜱ ᵛⁱᵖ° 🫧˹🇫ᏒΔṆℭỉ𝖴𝐌 𓆩ꭙᗪ𓆪 ˼ ᴘʀᴏᴛᴇᴄᴛᴇᴅ ɢʀᴏᴜᴘ.")
        else:
            try:
...
async def hang(e):
    if e.sender_id in SUDO_USERS:
        if e.chat_id in GROUP:
            await e.reply("» ꜱᴏʀʀʏ, ᴛʜɪꜱ ɪꜱ ᵛⁱᵖ° 🫧˹🇫ᏒΔṆℭỉ𝖴𝐌 𓆩ꭙᗪ𓆪 ˼ ᴘʀᴏᴛᴇᴄᴛᴇᴅ ɢʀᴏᴜᴘ.")
        else:
            try:
